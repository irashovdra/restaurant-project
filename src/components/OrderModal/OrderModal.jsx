    ...
    return (
      <div className={styles.backdrop}>
        <div className={styles.orderModal}>
          <button onClick={} className={styles.orderModal__close}>
            <svg
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_5642_364"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_5642_364"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_i_5642_364"
                  x="6.62109"
                  y="6.62109"
                  width="12.7588"
                  height="11.7587"
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="shape"
                    result="effect1_innerShadow_5642_364"
                  />
                </filter>
              </defs>
            </svg>
